...
if ($_POST['action'] != "") $_SESSION['action'] = $_POST['action'];
...
<?php echo $header; ?>
<table width="100%" bgcolor="#336600" align="right" colspan="2" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <table>
        <tr>
...
<a href="#" onclick="document.reqs.action.value=\'editor\'; document.reqs.file.value=\'' . $linkfile . '\'; document.reqs.submit();" title="Edit">E</a></tr>';
      ...
      if ($action == "editor") {
        ...
        function readf($file)
        {
          if (!$le = fopen($file, "rb")) $contents = "Can't open file, permission denide";
          else {
